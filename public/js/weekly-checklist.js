...
function weekHeader(start, end) {
  ...
  if (startMonth === endMonth) return `Week ${week} of ${startMonth}`;
  return `Week ${week} of ${startMonth} / Week 1 of ${end.toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}`;
}
