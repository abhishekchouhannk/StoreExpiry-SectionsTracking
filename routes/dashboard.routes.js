...
const { isValidEmployeeName, normalizeName } = require('../utils/employeeName');
...
// FIXED: now reuses currentPeriod() instead of duplicating the week-calc logic
// (see bug list — previously used Math.min(5,...) while cleaning-details used Math.min(4,...))
